import 'package:cp_groceries/common_widget/explore_cell.dart';
import 'package:cp_groceries/view/explore/explore_details_view.dart';
import 'package:cp_groceries/view/explore/search_view.dart';
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: ((context, index) {
                var eObj = findProductsArr[index] as Map? ?? {};
                return ExploreCell(
                  pObj: eObj,
                  onPressed: () {
                    Navigator.push(
